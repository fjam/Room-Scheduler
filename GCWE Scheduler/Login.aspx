<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GCWE_Scheduler.Login" %>
       ...
       $('#divID').css('min-height',windowHeight+'px');
        ...
        <p>
           <div id ="staffhourtable">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" AllowSorting="True" BorderColor="White" Font-Bold="False" DataKeyNames="Id">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [StaffHours]"></asp:SqlDataSource>
               </div>
        </p>
    </form>
    <p>
